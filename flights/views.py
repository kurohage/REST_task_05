...
from .serializers import FlightSerializer, BookingSerializer, BookingDetailsSerializer, UpdateBookingSerializer, RegisterSerializer, UpdateBookingNonAdminsSerializer
...
class UpdateBooking(RetrieveUpdateAPIView):
	...
	def get_serializer_class(self):
		...
		return UpdateBookingNonAdminsSerializer
